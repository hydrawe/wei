...
export const arabicDescriptions: Record<string, string> = {
  ...
  'ن': 'Nun - n',
  'ش': 'Shin - sc',
  'ص': 'Sad - sv (stressed s, thicker)',
  'ض': 'Dad - dv',
  'ط': 'Ta (emphatic) - tv (back of mouth)',
  'ظ': 'Za (emphatic) - zv (further back)',
  'ب': 'Ba - b',
  'ف': 'Fa - f',
  'ك': 'Kaf - k',
  'ق': 'Qaf - q (deep in throat)',
  'ع': 'Ayn - g (surprised "a")',
  'غ': 'Ghayn - gc (gargling sound)',
  'ه': 'Ha - h',
  'ج': 'Jim - j',
  'ح': 'Ha (emphatic) - x (fogging up window)',
  'خ': 'Kha - xc (whispered gargle)',
  'م': 'Mim - m',
}
